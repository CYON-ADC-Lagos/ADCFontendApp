...
export { default as Gallery } from "./Landing/PhotoGallery";
export { default as Events } from "./Landing/Events";
export { default as Executives } from "./Landing/Executives";
export { default as Sponsors } from "./Landing/Sponsors";
export { default as Downloads } from "./Landing/Downloads";
...
export { default as Vision } from "./AboutUs/Vision";
